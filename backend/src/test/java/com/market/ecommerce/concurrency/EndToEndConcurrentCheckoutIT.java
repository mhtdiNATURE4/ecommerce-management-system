...
@ActiveProfiles("test")
public class EndToEndConcurrentCheckoutIT {
    ...
    void setup() {
        ...
        Category category = categoryRepository.save(Category.builder().name("E2E Cat").build());
        ...
        User a = User.builder().name("User A").email("e2e-a@example.com").password(passwordEncoder.encode("passA")).build();
        User b = User.builder().name("User B").email("e2e-b@example.com").password(passwordEncoder.encode("passB")).build();
        ...
        LoginRequest loginA = new LoginRequest("e2e-a@example.com", "passA");
        ...
        LoginRequest loginB = new LoginRequest("e2e-b@example.com", "passB");
